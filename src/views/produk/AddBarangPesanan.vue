	...
	<div>
		<CCard>
			...
			<CCardFooter class="d-flex justify-content-center mt-4">
				<CButton type="submit" color="light" @click.prevent="addBarangPesanan">
		...
		methods: {
			addBarangPesanan() {
				...
				if(!this.errors.length) {
					...
					this.label = 'Loading...'
					this.$http.post('https://young-temple-67589.herokuapp.com/api/barang/pesanan', this.barang_pesanan, {
						headers: {
